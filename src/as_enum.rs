...
pub enum DrmFourcc {
    ...
    Avuy8888 = consts::DRM_FOURCC_AVUY8888,
    ...
    C1 = consts::DRM_FOURCC_C1,
    C2 = consts::DRM_FOURCC_C2,
    C4 = consts::DRM_FOURCC_C4,
    C8 = consts::DRM_FOURCC_C8,
    D1 = consts::DRM_FOURCC_D1,
    D2 = consts::DRM_FOURCC_D2,
    D4 = consts::DRM_FOURCC_D4,
    D8 = consts::DRM_FOURCC_D8,
    ...
    Nv20 = consts::DRM_FOURCC_NV20,
    Nv21 = consts::DRM_FOURCC_NV21,
    Nv24 = consts::DRM_FOURCC_NV24,
    Nv30 = consts::DRM_FOURCC_NV30,
    ...
    P030 = consts::DRM_FOURCC_P030,
    P210 = consts::DRM_FOURCC_P210,
    Q401 = consts::DRM_FOURCC_Q401,
    Q410 = consts::DRM_FOURCC_Q410,
    R1 = consts::DRM_FOURCC_R1,
    R10 = consts::DRM_FOURCC_R10,
    R12 = consts::DRM_FOURCC_R12,
    R16 = consts::DRM_FOURCC_R16,
    R2 = consts::DRM_FOURCC_R2,
    R4 = consts::DRM_FOURCC_R4,
    ...
    S010 = consts::DRM_FOURCC_S010,
    S012 = consts::DRM_FOURCC_S012,
    S016 = consts::DRM_FOURCC_S016,
    S210 = consts::DRM_FOURCC_S210,
    S212 = consts::DRM_FOURCC_S212,
    S216 = consts::DRM_FOURCC_S216,
    S410 = consts::DRM_FOURCC_S410,
    S412 = consts::DRM_FOURCC_S412,
    S416 = consts::DRM_FOURCC_S416,
    ...
    Xvuy8888 = consts::DRM_FOURCC_XVUY8888,
...
impl DrmFourcc {
    pub(crate) fn from_u32(n: u32) -> Option<Self> {
        match n {
            ...
            consts::DRM_FOURCC_AVUY8888 => Some(Self::Avuy8888),
            ...
            consts::DRM_FOURCC_C1 => Some(Self::C1),
            consts::DRM_FOURCC_C2 => Some(Self::C2),
            consts::DRM_FOURCC_C4 => Some(Self::C4),
            consts::DRM_FOURCC_C8 => Some(Self::C8),
            consts::DRM_FOURCC_D1 => Some(Self::D1),
            consts::DRM_FOURCC_D2 => Some(Self::D2),
            consts::DRM_FOURCC_D4 => Some(Self::D4),
            consts::DRM_FOURCC_D8 => Some(Self::D8),
            ...
            consts::DRM_FOURCC_NV20 => Some(Self::Nv20),
            consts::DRM_FOURCC_NV21 => Some(Self::Nv21),
            consts::DRM_FOURCC_NV24 => Some(Self::Nv24),
            consts::DRM_FOURCC_NV30 => Some(Self::Nv30),
            ...
            consts::DRM_FOURCC_P030 => Some(Self::P030),
            consts::DRM_FOURCC_P210 => Some(Self::P210),
            consts::DRM_FOURCC_Q401 => Some(Self::Q401),
            consts::DRM_FOURCC_Q410 => Some(Self::Q410),
            consts::DRM_FOURCC_R1 => Some(Self::R1),
            consts::DRM_FOURCC_R10 => Some(Self::R10),
            consts::DRM_FOURCC_R12 => Some(Self::R12),
            consts::DRM_FOURCC_R16 => Some(Self::R16),
            consts::DRM_FOURCC_R2 => Some(Self::R2),
            consts::DRM_FOURCC_R4 => Some(Self::R4),
            ...
            consts::DRM_FOURCC_S010 => Some(Self::S010),
            consts::DRM_FOURCC_S012 => Some(Self::S012),
            consts::DRM_FOURCC_S016 => Some(Self::S016),
            consts::DRM_FOURCC_S210 => Some(Self::S210),
            consts::DRM_FOURCC_S212 => Some(Self::S212),
            consts::DRM_FOURCC_S216 => Some(Self::S216),
            consts::DRM_FOURCC_S410 => Some(Self::S410),
            consts::DRM_FOURCC_S412 => Some(Self::S412),
            consts::DRM_FOURCC_S416 => Some(Self::S416),
            ...
            consts::DRM_FOURCC_XVUY8888 => Some(Self::Xvuy8888),
